- [[#KERBEROS|KERBEROS]]
- [[#Commands|Commands]]
	- [[#Commands#Credential Injection|Credential Injection]]
- [[#BREACHING|BREACHING]]
	- [[#BREACHING#NTLM|NTLM]]
	- [[#BREACHING#LDAP|LDAP]]
	- [[#BREACHING#Authentication Relays|Authentication Relays]]
	- [[#BREACHING#MDT|MDT]]
	- [[#BREACHING#Config Files|Config Files]]
- [[#ENUMERATING|ENUMERATING]]
	- [[#ENUMERATING#BLOODHOUND|BLOODHOUND]]
- [[#EXPLOITNG AD|EXPLOITNG AD]]
	- [[#EXPLOITNG AD#Delegating Permission|Delegating Permission]]
	- [[#EXPLOITNG AD#Certicate Template|Certicate Template]]
	- [[#EXPLOITNG AD#Kerberos Delegation|Kerberos Delegation]]
	- [[#EXPLOITNG AD#Exploit Users|Exploit Users]]
- [[#LATERAL MOVEMENT|LATERAL MOVEMENT]]
	- [[#LATERAL MOVEMENT#WMI|WMI]]
	- [[#LATERAL MOVEMENT#Other Authentication Methods|Other Authentication Methods]]
		- [[#Other Authentication Methods#MIMIKATZ|MIMIKATZ]]
		- [[#Other Authentication Methods#With Linux|With Linux]]
		- [[#Other Authentication Methods#Kerberos|Kerberos]]
		- [[#Other Authentication Methods#Overpass-the-hash / pass-the-key|Overpass-the-hash / pass-the-key]]
		- [[#Other Authentication Methods#Abusing Behaviour|Abusing Behaviour]]
		- [[#Other Authentication Methods#Port Forwarding|Port Forwarding]]
- [[#PERSISTING AD|PERSISTING AD]]
	- [[#PERSISTING AD#POWERVIEW|POWERVIEW]]
	- [[#PERSISTING AD#create reverse shell|create reverse shell]]
	- [[#PERSISTING AD#Credentials|Credentials]]
	- [[#PERSISTING AD#Golden/Silver Ticket|Golden/Silver Ticket]]
	- [[#PERSISTING AD#Persistance with Certificate|Persistance with Certificate]]
	- [[#PERSISTING AD#SID History|SID History]]
	- [[#PERSISTING AD#Group membership|Group membership]]
	- [[#PERSISTING AD#With Access Control List ACLs|With Access Control List ACLs]]
	- [[#PERSISTING AD#GPS|GPS]]
- [[#CREDENTIALS HARVESTING|CREDENTIALS HARVESTING]]
	- [[#CREDENTIALS HARVESTING#Security Account Manager (SAM)|Security Account Manager (SAM)]]
	- [[#CREDENTIALS HARVESTING#Local Security Authority Subsystem Service (LSASS)|Local Security Authority Subsystem Service (LSASS)]]
	- [[#CREDENTIALS HARVESTING#Windowa Credential Manager|Windowa Credential Manager]]
	- [[#CREDENTIALS HARVESTING#Domain Controller|Domain Controller]]
	- [[#CREDENTIALS HARVESTING#Local Admin Password Solution (LAPS)|Local Admin Password Solution (LAPS)]]
...
-  xfreerdp /v:VICTIM_IP /u:USER /p:'password' +clipboard /dynamic-resolution /drive:/home/bruno/git,share /workarea /cert:ignore
...
# /admin
# /domain
# /ptt: inject in the current session

# Checking if ticket is running
...
- Forge certificate
  - ForgeCert and Rubeus
    ...
    - C:\Tools\Rubeus.exe asktgt /user:Administrator /enctype:aes256 /certificate::pfx /password:Password123 /outfile:.kirbi /domain:za.tryhackme.loc /dc:
