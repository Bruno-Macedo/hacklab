- [Enumeration](#enumeration)
  ...
  - [Powerview / Sharpview](#powerview--sharpview)
    - [Users](#users)
    - [Groups](#groups)
    - [AD computers](#ad-computers)
    - [ACLs](#acls)
    - [GPOs](#gpos)
    - [AD Trusts](#ad-trusts)
  - [KERBEROS](#kerberos)
        - [Tickets (need to be deleted)](#tickets-need-to-be-deleted)
    - [Commands](#commands)
  ...
  - [Attacks](#attacks)
    ...
    - [KAS-REProasting](#kas-reproasting)
    - [KGPP Passwords](#kgpp-passwords)
    - [KMisconfigured GPO Permissions (or GPO-deployed files)](#kmisconfigured-gpo-permissions-or-gpo-deployed-files)
    - [KCredentials in Network Shares](#kcredentials-in-network-shares)
    - [KCredentials in User Attributes](#kcredentials-in-user-attributes)
    - [KDCSync](#kdcsync)
    - [KKerberos Golden Ticket](#kkerberos-golden-ticket)
    - [KKerberos Constrained Delegation attack](#kkerberos-constrained-delegation-attack)
    - [KPrint Spooler \& NTLM Relaying](#kprint-spooler--ntlm-relaying)
    - [KCoercing attacks \& Kerberos Unconstrained Delegation](#kcoercing-attacks--kerberos-unconstrained-delegation)
    - [KObject ACLs](#kobject-acls)
    - [KPKI Misconfigurations - ESC1](#kpki-misconfigurations---esc1)
    - [KPKI Misconfigurations - ESC8 (Coercing + Certificates)](#kpki-misconfigurations---esc8-coercing--certificates)
...
- Get-DomainComputer
  ...
  - -Unconstrained = impersonate user, the compuzter can access other services
  - -TrustedtoAuth = constrained delegation = adm can enforce application of trust bondaries, limiting scope of service = whcih service account can delecate
...
### KAS-REProasting
### KGPP Passwords
### KMisconfigured GPO Permissions (or GPO-deployed files)
### KCredentials in Network Shares
### KCredentials in User Attributes
### KDCSync
### KKerberos Golden Ticket
### KKerberos Constrained Delegation attack
### KPrint Spooler & NTLM Relaying
### KCoercing attacks & Kerberos Unconstrained Delegation
### KObject ACLs
### KPKI Misconfigurations - ESC1
### KPKI Misconfigurations - ESC8 (Coercing + Certificates)