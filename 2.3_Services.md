...
- **Access to Target**
  ...
  - **xfreerdp**
    - xfreerdp /f /u:USERNAME /p:PASSWORD /v:HOST[:PORT]
      - /f: fullscreen
    - xfreerdp /v:IP /u:USERNAME /p:123456 +clipboard /dynamic-resolution //drive:linux,/home/plaintext/htb/academy/filetransfer
      - hash: /pth:HASH
    - Mount local folder:
      - xfreerdp /u:admin /p:password /cert:ignore /v:10.10.134.246 /workarea //drive:linux,/home/plaintext/htb/academy/filetransfer +drives
  - **rdesktop**
